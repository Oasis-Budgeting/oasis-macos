...
struct ContentView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            ...
            // formToken is explicitly NOT populated from storedAuthToken
            // to prevent sensitive credential exposure in the UI state.
    ...
    private func connectWithToken() async {
        ...
        storedAuthToken = newToken.isEmpty ? storedAuthToken : newToken
