...
struct ContentView: View {
    ...
    private func connectWithToken() async {
        defer { formToken = "" }
        storedServerURL = formServerURL.trimmingCharacters(in: .whitespacesAndNewlines)
        let resolvedToken = formToken.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty ? storedAuthToken : formToken.trimmingCharacters(in: .whitespacesAndNewlines)
